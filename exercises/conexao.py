...
class Gui():
    ...
    iblnome = Label(window, text="Nome")
    iblsobrenome = Label(window, text="Sobrenome")
    iblemail = Label(window, text="Email")
    iblcpf = Label(window, text="CPF")
    ...
    iblnome.grid(row=0, column=0)
    iblsobrenome.grid(row=1, column=0)
    iblemail.grid(row=2, column=0)
    iblcpf.grid(row=3, column=0)
